...
inputDir = 'C:\Users\dk3952\Dropbox\Hannes\17.4.2016\D';
myfiles = dir(inputDir);
mkdir([inputDir filesep 'RedChannel']);
...
for i=1:length(myfiles)
   ...
   currentImage = imread([inputDir filesep myfiles(i).name], 2);
   imwrite(currentImage, [inputDir filesep 'RedChannel' filesep myfiles(i).name]);    
end